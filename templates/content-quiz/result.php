...
<div class="quiz-result <?php echo esc_attr( $result['grade'] ); ?>">
    ...
    <div class="result-grade">
        ...
        <?php if($quiz_data->get_percent_result() == '100%') { ?> <a href=<?php $next_item ? echo $next_item->get_permalink(): echo site_url('course-catalog', 'https'); ?>> <button class="btn-primary">Continue Learning</button></a>
        <?php } ?>
    </div>
